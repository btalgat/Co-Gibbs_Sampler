...
class Window(Frame):
    ...
    def init_window(self):
        ...
        # self.lbGibbs.grid(row=5, column=0,  columnspan=2, padx=10, sticky=SW)
        ...
        # self.prog_bar = Progress(self.proc_frame, row=1, column=1, columnspan=1)
        # self.prog_bar.pb_clear()
        ...
        # self.stopbtn = Button(self.data_frame, text="Stop", command=self.stop).grid(row=90, column=1, sticky=E)
